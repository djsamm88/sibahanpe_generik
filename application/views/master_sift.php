    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="form_tambah_admin">
            ...
            <div class="col-sm-4">Nama Sift</div>
            <div class="col-sm-8"><input type="text" name="nama_sift" id="nama_sift" required="required" class="form-control" placeholder="Nama Sift"></div>
            <div style="clear: both;"></div><br>

            <div class="col-sm-4">Jam Masuk </div>
            <div class="col-sm-8">
                    <input type="text" id="masuk"  name="masuk" class="form-control" placeholder="00:00">
                    <i>Format 00:00 | 24 jam</i>
            </div>
            <div style="clear: both;"></div><br>

            <div class="col-sm-4">Jam Keluar </div>
            <div class="col-sm-8">
                    <input type="text" id="keluar"  name="keluar" class="form-control" placeholder="00:00">
                    <i>Format 00:00 | 24 jam</i>
            </div>
            <div style="clear: both;"></div><br>
...
function edit(id)
{
  $.get("<?php echo base_url()?>index.php/"+classnya+"/master_sift_by_id/"+id,function(e){
    //console.log(e[0].id);
    $("#id").val(e[0].id);
    $("#nama_sift").val(e[0].nama_sift);
    $("#masuk").val(e[0].masuk);
    $("#keluar").val(e[0].keluar);
...
$("#form_tambah_admin").on("submit",function(){
  ...
  var ser = $(this).serialize();
      ...
      $.ajax({
            url: "<?php echo base_url()?>index.php/"+classnya+"/simpan_master_sift",
            type: "POST",
            contentType: false,
            processData:false,
...
$("#myModal").on("hidden.bs.modal", function () {
  eksekusi_controller('<?php echo base_url()?>index.php/'+classnya+'/master_sift',document.title);
});
