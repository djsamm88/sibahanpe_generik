...
<div class="box">
        <div class="box-header with-border">
          <h3 class="box-title" id="judul2">Log Ijin Lainnya</h3>
...
function setujui(x,z)
{
  ...
  {
    $.get("<?php echo base_url()?>index.php/absensi/setujui_cuti_lain",{action:x,id:z},function(x){
        console.log(x);
        ...
        eksekusi_controller('<?php echo base_url()?>index.php/absensi/cuti_lain/?tgl_awal='+tgl_awal+'&tgl_akhir='+tgl_akhir,'Log Absensi');
...
$("#download_pdf").on("click",function(){
  ...
  var url="<?php echo base_url()?>index.php/absensi/cuti_lain_xl/?"+ser;
  window.open(url);
