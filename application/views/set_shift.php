...
<table id="tbl_datanya" class="table  table-striped table-bordered"  cellspacing="0" width="100%">
      ...
      <tbody>
        ...
        foreach($all as $x)
        {
          $btn = "<button class='btn btn-warning btn-xs' onclick='edit($x->id);return false;'>Shift</button>
                   ";
          $no++;
...
$("#myModal").on("hidden.bs.modal", function () {
  eksekusi_controller('<?php echo base_url()?>index.php/'+classnya+'/set_shift',document.title);
});
