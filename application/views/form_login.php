			...
			<form id="form_login_test" style="margin:0 auto;">
					<table id="form_login">
						...
						<tr>
							...
							<td>
								<input name="captcha" type="text" class="form-control" size="10" id="captcha" placeholder="Security Code" value="<?php echo $random?>" required /> 		
								<br>														
							</td>
						</tr>
...
<footer class="footer">
      <div class="container">
        <p class="text-muted">Copyright 2021 dutaindomakmur.com | medantechno.com</p>
      </div>
</footer>
