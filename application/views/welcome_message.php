...
function count_dinas_luar()
{
  $.get("<?php echo base_url()?>index.php/absensi/count_dinas_luar",function(e){
    $(".badge_dinas_luar").html("");
      if(e !="0")
      {
        $(".badge_dinas_luar").html("<font color='red'>"+e+"</font>");
      }
  })
}
...
function count_ijin_lain()
{
  $.get("<?php echo base_url()?>index.php/absensi/count_ijin_lain",function(e){
    $(".badge_ijin_lain").html("");
      if(e !="0")
      {
        $(".badge_ijin_lain").html("<font color='red'>"+e+"</font>");
      }
  })
}
